...
const Contact = () => {
  ...
  useEffect(() => {
    emailjs.init("g_P0rWL96VVt7urEr"); // emailjs public key
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await emailjs.send(
        "service_xfoi2zf", // EmailJS service ID
        "template_po0h9g7", // EmailJS template ID
        templateParams
      );
        ...
        >
          <div>
            ...
            <input
              type="text"
              name="name"
              className={`mt-1 block w-full rounded-md shadow-sm focus:ring-2 focus:ring-slate-500 focus:border-slate-500 text-base
                py-3 px-4 ${
